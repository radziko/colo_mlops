...
def main():
    ...
    img = image_select(
        ...
        images=[
            Image.open("images/car1.jpg"),
            Image.open("images/deer1.jpg"),
            Image.open("images/dog1.jpg"),
            Image.open("images/ship1.jpg"),
            Image.open("images/bird1.jpg"),
            Image.open("images/cat1.jpg"),
            Image.open("images/frog1.jpg"),
            Image.open("images/truck1.jpg"),
            Image.open("images/airplane1.jpg"),
            Image.open("images/horse1.jpg"),
        ],
        captions=[
            "Automobile",
            "Deer",
